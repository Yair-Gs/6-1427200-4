...
function addDynamicStyles() {
 ...
 function changeImage(src) {
      ...
      document.querySelectorAll('.h-20').forEach(el => el.classList.remove('border-blue-500'));
      document.querySelectorAll('.h-20').forEach(el => el.classList.add('border-gray-300'));
      event.target.closest('.h-20').classList.remove('border-gray-300');
      event.target.closest('.h-20').classList.add('border-blue-500');
    }
